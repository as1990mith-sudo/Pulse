...
export const HOME_ADMIN_SECTIONS: HomeAdminSection[] = [
  ...
  },
  {
    ...
    label: "Content",
    icon: FileText,
    description: "Publish announcements, articles, devotionals and media to your members.",
  ...
  },
  {
    ...
    label: "Events",
    icon: CalendarDays,
    description: "Plan services, meetings and gatherings on your Home calendar.",
