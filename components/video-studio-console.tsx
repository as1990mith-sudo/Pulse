      ...
      >
        ...
        {!live && (
          <LiveSetupSheet
            ...
            layoutValue={orientation}
            onLayoutSelect={(v) => setOrientation(v as LiveOrientation)}
            layoutHint={orientation === "landscape" ? "A community gathering" : "Stage, teaching & preaching"}
            summaryLayoutLabel={orientation === "landscape" ? "Conversation" : "Broadcast"}
            cover={cover}
            onCoverChange={setCover}
            topic={
              orientation === "landscape"
                ? { value: roomTopic, onChange: setRoomTopic, placeholder: "What are we gathering around?" }
                : null
            }
            category={category}
