  ...
  return (
    <span ref={wrapRef} className={cn("relative inline-flex shrink-0", className)}>
      ...
      {open && (
        <span
          role="status"
          className="absolute top-full left-1/2 z-50 mt-1.5 -translate-x-1/2 whitespace-nowrap rounded-md bg-foreground px-2.5 py-1 text-xs font-normal text-background shadow-md"
        >
          Post was edited.
        </span>
      )}
