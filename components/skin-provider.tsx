...
export const SKIN_INIT_SCRIPT = `try{var s=localStorage.getItem('${SKIN_STORAGE_KEY}');if(!s||['orange','white','black','yellow'].indexOf(s)<0)s='orange';document.documentElement.dataset.skin=s;}catch(e){document.documentElement.dataset.skin='orange';}`
