    ...
    <div className="min-h-screen">
      ...
      <main>
        <div className="mx-auto w-full max-w-3xl px-4 py-8 sm:px-6">
          <div className="mb-6">
            <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">Chatrooms</h1>
            <p className="mt-1.5 text-pretty leading-relaxed text-muted-foreground">
              Private group chats for your community. Create a room, invite members, and keep the conversation going.
            </p>
          </div>
